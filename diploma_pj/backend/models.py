...
class ProductInfo(models.Model):
     ...
     price_rrc = models.PositiveIntegerField(null=True, blank=True, verbose_name='Recommended retail price')
     class Meta:
...
class ProductParameter(models.Model):
    product_info = models.ForeignKey(ProductInfo, on_delete=models.CASCADE, verbose_name='Product information', related_name='parameters')
    parameter = models.ForeignKey(Parameter, on_delete=models.CASCADE, verbose_name='Parameter', related_name='product_parameters')
...
class Order(models.Model):
    ...
    status = models.CharField(choises=STATUS_CHOICES, default='new', verbose_name='Status', max_length=20)
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name='Product', related_name='order_items')
    shop = models.ForeignKey(Shop, on_delete=models.CASCADE, verbose_name='Shop', related_name='shop_items')
    quantity = models.PositiveIntegerField(verbose_name='Quantity')
...
class Contact(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='User', related_name='contacts')
